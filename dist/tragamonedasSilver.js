...
exports.TragamonedaBasica = void 0;
const tragamonedas_1 = require("./tragamonedas");
const readlineSync = __importStar(require("readline-sync"));
const clear_1 = __importDefault(require("clear"));
class TragamonedaBasica extends tragamonedas_1.Tragamonedas {
    ...
    isWin() {
        ...
        this.numeros = [];
        return this.ganoPerdio(resultado, (this.montoApostado));
    }
    play(player) {
...
exports.TragamonedaBasica = TragamonedaBasica;
